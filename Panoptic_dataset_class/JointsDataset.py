...
from Panoptic_dataset_class.utils.transforms import get_affine_transform, affine_transform, get_scale, scale_coords
...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input = cv2.warpAffine(
            data_numpy,
            trans, (int(self.image_size[0]), int(self.image_size[1])), # (w, h)
        ...
        # Box rescaling
        boxes = db_rec['bounding_boxes']
        boxes = scale_coords(boxes, data_numpy.shape, self.image_size)
